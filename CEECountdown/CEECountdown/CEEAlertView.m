...
#import "CEEAlertView.h"
#import <objc/runtime.h>

@interface CEEAlertView ()<UIAlertViewDelegate>

@end

@implementation CEEAlertView

void CEENoTitleAlert(NSString* message) {
       ...
       otherButtonTitles:(NSString *)otherButtonTitles, ...
{
    ...
    CEEAlertView *alertView = [[self alloc] initWithTitle:title
                                                 message:message
