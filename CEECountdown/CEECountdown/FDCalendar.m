...
- (void)setupTitleBar {
    ...
    UIButton *leftButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 10, 32, 24)];
    [leftButton setImage:[UIImage imageNamed:@"calendar_left"] forState:UIControlStateNormal];
    ...
    [rightButton setImage:[UIImage imageNamed:@"calendar_right"] forState:UIControlStateNormal];
    ...
    titleButton.titleLabel.textColor = [UIColor blueColor];
    [titleButton setTitleColor:[UIColor colorWithRed:106.f/255.f green:57.f/255.f blue:6.f /255.f alpha:1] forState:UIControlStateNormal];
...
- (void)setupWeekHeader {
    ...
    for (int i = 0; i < count; i++) {
        UILabel *weekdayLabel = [[UILabel alloc] initWithFrame:CGRectMake(offsetX, 60, (DeviceWidth - 10) / count, 20)];
        weekdayLabel.textAlignment = NSTextAlignmentCenter;
        weekdayLabel.text = Weekdays[i];
        weekdayLabel.font=[UIFont systemFontOfSize:10];
        
        if (i == 0 || i == count - 1) {
            weekdayLabel.textColor = [UIColor colorWithRed:106.f/255.f green:57.f/255.f blue:6.f /255.f alpha:1];
        } else {
            weekdayLabel.textColor = [UIColor colorWithRed:106.f/255.f green:57.f/255.f blue:6.f /255.f alpha:1];
        }
